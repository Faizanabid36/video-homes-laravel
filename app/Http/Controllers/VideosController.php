...
class VideosController extends Controller {
	...
	public function index() {
		...
		$pendingVideos  = isset( $videos[0] ) ? $videos[0] : array();
		$approvedVideos = isset( $videos[1] ) ? $videos[1] : array();
	...
	public function video_with_views() {
		...
		$videos_table_data = collect( $videos )->map(
			function ( $d ) use ( $startDate, $endDate ) {

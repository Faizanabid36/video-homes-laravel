...
Route::get('/directory/sub_category/{id}','MainController@directory_by_sub_category')->name('directory_by_sub_category');
Route::get('/directory/{username}','MainController@directory_by_username')->name('directory_by_username');
Route::get('/directory/list/{username}','MainController@directory_by_username')->name('directory_by_user');

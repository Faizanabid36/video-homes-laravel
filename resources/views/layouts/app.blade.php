...
{{--    --}}{{--    </nav>--}}
{{--    <nav class="navbar navbar-findcond navbar-fixed-top header-layout">--}}
{{--        <div class="pt_main_hdr" id="header_change" style="float: left">--}}
{{--            <div class="navbar-header">--}}
        ...
        <div class="pt_main_hdr pull-right" id="header_change">
            <ul class="nav navbar-nav navbar-right" style="display: inline;float: right !important">
                @if(auth()->user())
                    ...
                    {{--                    </li>--}}
                    <li>
                        <a href="#/upload_video" class="btn upload-button">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path fill="currentColor"
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="#/profile">
                                    ...
                                    {{--                                    <div><span>Customize Player</span></div>--}}
                                </a>
                            </li>
                            <li>
                            ...
                            {{--                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">--}}
                            {{--                                        <path fill="currentColor"--}}
                            {{--                                              d="M8 19h8c.55 0 1-.45 1-1V5c0-.55-.45-1-1-1H8c-.55 0-1 .45-1 1v13c0 .55.45 1 1 1zm-5-2h2c.55 0 1-.45 1-1V7c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1zM18 7v9c0 .55.45 1 1 1h2c.55 0 1-.45 1-1V7c0-.55-.45-1-1-1h-2c-.55 0-1 .45-1 1z"></path>--}}
                            {{--                                    </svg>--}}
                            {{--                                    Popular Channels--}}
                            {{--                                </a>--}}
                            {{--                            </li>--}}

<div class="form-group {{ $errors->has('title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="title" type="text" id="title" value="{{ isset($settings->title) ? $settings->title : ''}}" required>
    {!! $errors->first('title', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
    <label for="description" class="control-label">{{ 'Meta Description' }}</label>
    <input class="form-control" name="description" type="text" id="description" value="{{ isset($settings->description) ? $settings->description : ''}}" required>
...
<div class="form-group {{ $errors->has('display_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="display_title" type="text" id="display_title" value="{{ isset($settings->display_title) ? $settings->display_title : ''}}" required>
...
<div class="form-group {{ $errors->has('button_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="button_1" type="text" id="button_1" value="{{ isset($settings->button_1) ? $settings->button_1 : ''}}" required>
...
<div class="form-group {{ $errors->has('button_1_link') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="button_1_link" type="text" id="button_1_link" value="{{ isset($settings->button_1_link) ? $settings->button_1_link : ''}}" required>
...
<div class="form-group {{ $errors->has('button_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="button_2" type="text" id="button_2" value="{{ isset($settings->button_2) ? $settings->button_2 : ''}}" required>
...
<div class="form-group {{ $errors->has('button_2_link') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="button_2_link" type="text" id="button_2_link" value="{{ isset($settings->button_2_link) ? $settings->button_2_link : ''}}" required>
...
<div class="form-group {{ $errors->has('box_1') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="box_1" type="text" id="box_1" value="{{ isset($settings->box_1) ? $settings->box_1 : ''}}" required>
...
<div class="form-group {{ $errors->has('box_2') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="box_2" type="text" id="box_2" value="{{ isset($settings->box_2) ? $settings->box_2 : ''}}" required>
...
<div class="form-group {{ $errors->has('box_3') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="box_3" type="text" id="box_3" value="{{ isset($settings->box_3) ? $settings->box_3 : ''}}" required>
...
<div class="form-group {{ $errors->has('box_4') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="box_4" type="text" id="box_4" value="{{ isset($settings->box_4) ? $settings->box_4 : ''}}" required>
...
<div class="form-group {{ $errors->has('parallax_video') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="parallax_video" type="text" id="parallax_video" value="{{ isset($settings->parallax_video) ? $settings->parallax_video : ''}}" required>
...
<div class="form-group {{ $errors->has('call_to_action_title') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="call_to_action_title" type="text" id="call_to_action_title" value="{{ isset($settings->call_to_action_title) ? $settings->call_to_action_title : ''}}" required>
...
<div class="form-group {{ $errors->has('call_to_action') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="call_to_action" type="text" id="call_to_action" value="{{ isset($settings->call_to_action) ? $settings->call_to_action : ''}}" required>
...
<div class="form-group {{ $errors->has('call_to_action_link') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="call_to_action_link" type="text" id="call_to_action_link" value="{{ isset($settings->call_to_action_link) ? $settings->call_to_action_link : ''}}" required>
...
<div class="form-group {{ $errors->has('footer') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="footer" type="text" id="footer" value="{{ isset($settings->footer) ? $settings->footer : ''}}" required>

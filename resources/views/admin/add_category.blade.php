            ...
            <div class="col-lg-12">
                ...
                <div class="card inline_section_align media_max_1199">
                    ...
                    <div class="card-block">
                        <form action="{{action('AdminController@store_category')}}" method="POST">
                            @csrf
                            <fieldset>
                                <!-- Name input-->
                                <div class="form-group row form_inline_inputs_bot">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="input-group m-t-35">
                                            <input type="description" class="form-control" name="description" placeholder=" Category Description">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 m-t-35">
                                        <button class="btn btn-primary layout_btn_prevent btn-responsive form_inline_btn_margin-top">Add Category</button>
                                    </div>
                                </div>
                            </fieldset>
                        </form>

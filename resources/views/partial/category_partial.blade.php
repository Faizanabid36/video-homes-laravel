@if (count($user_category) > 0)
    @foreach($user_category as $k=> $u)
        <li class="dropdown-submenu">
            <a id="dropdownMenu{{$k}}" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="dropdown-item dropdown-toggle">Hover for action</a>

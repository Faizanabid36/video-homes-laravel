            ...
            <div class="login-form">
                ...
                <form action="{{route('register')}}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="name" id="username" placeholder="Username" required="" value="{{old('name')}}">
                    </div>
                    <div class="form-group">
                        <input type="text" name="email" id="email" placeholder="E-mail address" required="" value="{{old('email')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="terms" style="color: #fff">
                        <label for="accept_terms" style="font-size: 12px; cursor: pointer;"><input type="checkbox" style="float: left; width: auto; display: inline-block; margin-right: 5px; margin-top: 2px;" name="accept_terms" id="accept_terms">
                            ...
                            <a style="color: #fff; text-decoration: underline;" href="#">Terms of use</a> &amp; <a href="#" style="color: #fff; text-decoration: underline;">Privacy Policy</a>
                        </label>
                        <div class="clear"></div>
                    </div>

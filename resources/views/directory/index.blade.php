                                            ...
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    ...
                                                    @if ($video['user']['user_extra']['office_phone'] && $video['user']['user_extra']['office_phone'] != '')
                                                        <p class="card-text my-2"><i
                                                                class="fa icon-blue mr-2 fa-phone"></i> <b>Office
                                                                Phone:</b> <a
...
@section('script')
    @if (!request('category_id'))
        <script>
            ...
            function initMap() {
                    @if(!empty($users))
                let mapArea = document.getElementById('map'), i, map = new google.maps.Map(mapArea, {zoom: 7, center: {lat:-78.3090289,lng:39.2802198}}),

...
class Cropper extends _react.default.Component {
    constructor(...args) {
        ...
        _defineProperty(this, "setInitialCrop", () => {
            ...
            const {
                crop,
                zoom
            } = (0, _helpers.getInitialCropFromCroppedAreaPixels)(initialCroppedAreaPixels, this.mediaSize, cropSize);
        ...
        _defineProperty(this, "computeSizes", () => {
            ...
            if (mediaRef && this.containerRef) {
                var _this$imageRef, _this$videoRef, _this$imageRef2, _this$videoRef2, _this$state$cropSize, _this$state$cropSize2;

                this.containerRect = this.containerRef.getBoundingClientRect();
                this.mediaSize = {
                    width: mediaRef.offsetWidth,
                    height: mediaRef.offsetHeight,
                    naturalWidth: ((_this$imageRef = this.imageRef) === null || _this$imageRef === void 0 ? void 0 : _this$imageRef.naturalWidth) || ((_this$videoRef = this.videoRef) === null || _this$videoRef === void 0 ? void 0 : _this$videoRef.videoWidth) || 0,
                    naturalHeight: ((_this$imageRef2 = this.imageRef) === null || _this$imageRef2 === void 0 ? void 0 : _this$imageRef2.naturalHeight) || ((_this$videoRef2 = this.videoRef) === null || _this$videoRef2 === void 0 ? void 0 : _this$videoRef2.videoHeight) || 0
                };
                const cropSize = this.props.cropSize ? this.props.cropSize : (0, _helpers.getCropSize)(mediaRef.offsetWidth, mediaRef.offsetHeight, this.containerRect.width, this.containerRect.height, this.props.aspect, this.props.rotation);

                if (((_this$state$cropSize = this.state.cropSize) === null || _this$state$cropSize === void 0 ? void 0 : _this$state$cropSize.height) !== cropSize.height || ((_this$state$cropSize2 = this.state.cropSize) === null || _this$state$cropSize2 === void 0 ? void 0 : _this$state$cropSize2.width) !== cropSize.width) {
        ...
        _defineProperty(this, "onMouseMove", e => this.onDrag(Cropper.getMousePoint(e)));
        ...
        _defineProperty(this, "onDragStart", ({
            ...
            (_this$props$onInterac = (_this$props = this.props).onInteractionStart) === null || _this$props$onInterac === void 0 ? void 0 : _this$props$onInterac.call(_this$props);
        });

        _defineProperty(this, "onDrag", ({
                                             x,
                                             y
                                         }) => {
            ...
            this.rafDragTimeout = window.requestAnimationFrame(() => {
                ...
                const newPosition = this.props.restrictPosition ? (0, _helpers.restrictPosition)(requestedPosition, this.mediaSize, this.state.cropSize, this.props.zoom, this.props.rotation) : requestedPosition;
        ...
        _defineProperty(this, "onDragStopped", () => {
            ...
            this.cleanEvents();
            this.emitCropData();
            (_this$props$onInterac2 = (_this$props2 = this.props).onInteractionEnd) === null || _this$props$onInterac2 === void 0 ? void 0 : _this$props$onInterac2.call(_this$props2);
        });
        ...
        _defineProperty(this, "onWheel", e => {
            ...
            this.wheelTimer = window.setTimeout(() => this.setState({
                hasWheelJustStarted: false
            }, () => {
        ...
        _defineProperty(this, "getPointOnContainer", ({
                                                          x,
                                                          y
                                                      }) => {
        ...
        _defineProperty(this, "getPointOnMedia", ({
                                                      x,
                                                      y
                                                  }) => {
            const {
        ...
        _defineProperty(this, "setNewZoom", (zoom, point) => {
            ...
            const newPosition = this.props.restrictPosition ? (0, _helpers.restrictPosition)(requestedPosition, this.mediaSize, this.state.cropSize, newZoom, this.props.rotation) : requestedPosition;
            this.props.onCropChange(newPosition);
        ...
        _defineProperty(this, "getCropData", () => {
            ...
            const restrictedPosition = this.props.restrictPosition ? (0, _helpers.restrictPosition)(this.props.crop, this.mediaSize, this.state.cropSize, this.props.zoom, this.props.rotation) : this.props.crop;
            return (0, _helpers.computeCroppedArea)(restrictedPosition, this.mediaSize, this.state.cropSize, this.getAspect(), this.props.zoom, this.props.rotation, this.props.restrictPosition);
        });
        ...
        _defineProperty(this, "recomputeCropPosition", () => {
            if (!this.state.cropSize) return;
            const newPosition = this.props.restrictPosition ? (0, _helpers.restrictPosition)(this.props.crop, this.mediaSize, this.state.cropSize, this.props.zoom, this.props.rotation) : this.props.crop;
            this.props.onCropChange(newPosition);
            this.emitCropData();
        });
    }
    ...
    render() {
        ...
        return /*#__PURE__*/_react.default.createElement("div", {
            ...
            className: (0, _helpers.classNames)('reactEasyCrop_Container', containerClassName)
        }, image ? /*#__PURE__*/_react.default.createElement("img", _extends({
            alt: "",
            className: (0, _helpers.classNames)('reactEasyCrop_Image', mediaClassName)
        }, mediaProps, {
            src: image,
        ...
        })) : video && /*#__PURE__*/_react.default.createElement("video", _extends({
            autoPlay: true,
            loop: true,
            muted: true,
            className: (0, _helpers.classNames)('reactEasyCrop_Video', mediaClassName)
        }, mediaProps, {
            src: video,
            ...
            controls: false
        })), this.state.cropSize && /*#__PURE__*/_react.default.createElement("div", {
            style: { ...cropAreaStyle,
                width: this.state.cropSize.width,
                height: this.state.cropSize.height
            },
            "data-testid": "cropper",
            className: (0, _helpers.classNames)('reactEasyCrop_CropArea', cropShape === 'round' && 'reactEasyCrop_CropAreaRound', showGrid && 'reactEasyCrop_CropAreaGrid', cropAreaClassName)
        }));
    }

                        ...
                        >
                            <Tabs defaultActiveKey="1" tabPosition="left">
                                <TabPane tab="General" key="1">
                                    ...
                                    <ImgCrop modalTitle='Profile Picture' aspect={4 / 3} rotate zoom cropperProps={{step:0.1,minZoom:0.1}}>
                                            <Upload
                                    ...
                                    <Form.Item label="Company Logo">
                                        <ImgCrop modalTitle='Company Logo' aspect={4 / 3} rotate zoom cropperProps={{step:0.1,minZoom:0.1}}>
                                            <Upload
                                                headers={{'X-CSRF-TOKEN': window.document.head.querySelector('meta[name="csrf-token"]').content}}
                                                action={`${window.VIDEO_APP.base_url}/profile`}
                                                name='company_logo'

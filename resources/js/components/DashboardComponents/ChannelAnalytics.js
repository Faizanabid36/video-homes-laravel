...
class ChannelAnalytics extends React.Component{
    render(){
        return <div>
            <div className="mb_50">
                <h4>
                    ...
                    <div className="col-md-3 col-sm-6">
                        <div className="vp_mn_dash_stats">
                            <h2 style={{color: '#6abd46'}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="currentColor" d="M12,23A1,1 0 0,1 11,22V19H7A2,2 0 0,1 5,17V7A2,2 0 0,1 7,5H21A2,2 0 0,1 23,7V17A2,2 0 0,1 21,19H16.9L13.2,22.71C13,22.89 12.76,23 12.5,23H12M3,15H1V3A2,2 0 0,1 3,1H19V3H3V15Z"></path></svg>
                                Total Comments
                            </h2>
                            <p>0</p>
                        </div>
